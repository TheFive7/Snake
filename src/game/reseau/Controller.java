...
import static game.reseau.Draw.drawEtat;
import static game.reseau.Game.*;
import static game.reseau.Item.inverseControls;
        ...
        scene.setOnKeyPressed(event -> {
            ...
            if (key == KeyCode.UP || key == KeyCode.Z) {
                if (!inverseControls) {
                    ...
                    Serveur.out.print(snake.getDirection());
                    Serveur.out.flush();
                    Serveur.out.print(snake.getTailleSnake());
                    Serveur.out.flush();
                } else {
