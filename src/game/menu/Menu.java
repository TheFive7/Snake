...
public class Menu extends JFrame {
    ...
    public Menu() {
        ...
        // Mode Angle
        chkAngle.setSize(new Dimension(20, 20));
        ImageIcon iconCheckBoxAngleBase = new ImageIcon(new ImageIcon("src/img/croix.png").getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT));
        chkAngle.setIcon(iconCheckBoxAngleBase);
        chkAngle.addActionListener(e -> {
            if (modeAngle) {
                ImageIcon iconCheckBoxAngleOui = new ImageIcon(new ImageIcon("src/img/valide.png").getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT));
                chkAngle.setIcon(iconCheckBoxAngleOui);
            } else {
                ImageIcon iconCheckBoxAngleNon = new ImageIcon(new ImageIcon("src/img/croix.png").getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT));
